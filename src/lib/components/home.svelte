...
<Section id="home" class="hero max-w-full overflow-x-hidden bg-base-200">
	<div class="hero-content -mt-20 xl:max-w-screen-lg">
		<div class="flex flex-shrink-0 flex-col text-[4rem] leading-[1] sm:text-7xl font-bold">
			...
			<enhanced:img
				...
				alt="Cliparoo Mascot"
				class="mask-squircle w-[calc(100vw-3rem)] max-w-96 sm:max-w-none sm:size-96"
			/>
		</div>
		<div class="-mr-36 hidden bg-base-100 sm:block">
			<CliparooPageExample />
		</div>
	</div>
</Section>
